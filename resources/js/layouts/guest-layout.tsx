    ...
    return (
        <>
            ...
            <div className="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-background">
                <div className="w-full sm:max-w-md mt-6 px-8 py-6 bg-card shadow-md overflow-hidden sm:rounded-lg">
                    <div className="flex justify-center mb-5">
                        <Link href="/">
                            <ApplicationLogo className="w-24 h-24" />
                        </Link>
                    </div>
                    <h1 className="text-2xl font-bold text-center text-card-foreground mb-6">{title}</h1>
                    {children}
                </div>
            </div>
        </>
