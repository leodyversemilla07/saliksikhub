...
export const Pagination: React.FC<PaginationProps> = ({
    ...
    pageLabel = (meta) =>
        `Displaying page ${meta.current_page} of ${meta.last_page}`,
    className,
}) => {
        ...
        >
            <div className="flex min-w-[220px] items-center gap-4">
                <Select
                    ...
                    onValueChange={(val) =>
                        onPageSizeChange(val === 'all' ? -1 : Number(val))
                    }
                >
                    ...
                    <SelectContent className="w-[130px]">
                        {pageSizeOptions.map((val) => (
                            <SelectItem
                                ...
                                className={
                                    (pageSizeSelectValue === 'all' &&
                                        val === 'all') ||
                                    pageSizeSelectValue === String(val)
