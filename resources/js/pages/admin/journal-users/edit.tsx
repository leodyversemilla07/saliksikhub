                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Update the role or status for this journal user
                            assignment
                        </p>
                    </div>
                </div>
                        ...
                        <form onSubmit={submit}>
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Modify the role and active status of
                                        this assignment
                                    </CardDescription>
                                </CardHeader>
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-sm text-muted-foreground">
                                                Inactive assignments are
                                                preserved but the user cannot
                                                act in this role
                                            </p>
                                        </div>
                                        <Switch
                            ...
                            <CardContent className="space-y-3">
                                <div>
                                    ...
                                    <p className="font-medium">
                                        {journalUser.user.firstname}{' '}
                                        {journalUser.user.lastname}
                                    </p>
                                </div>
                                <div>
                                    <p className="text-sm font-medium text-muted-foreground">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm">
                                        {formatDate(journalUser.assigned_at)}
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
