...
const UserStatsCard: React.FC<{ title: string, value: string, icon: any, color: string }> = ({
...
export default function UserManagement({ users }: { users: PaginatedUser }) {
    ...
    const handlePageChange = (url: string | null) => {
        ...
        try {
            ...
            toast({
                title: "Error",
                description: "Navigation failed: Invalid URL",
                variant: "destructive"
            });
        }
    };
    ...
    const navigateToPage = (pageNumber: number) => {
        const baseUrl = route('editor.users.index');
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-between py-6 gap-4 border-t mt-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex items-center gap-2 ml-2 pl-2 border-l border-gray-200 dark:border-gray-700">
                                        ...
                                        <Select value={String(perPage)} onValueChange={(value) => handlePerPageChange({ target: { value } } as any)}>
